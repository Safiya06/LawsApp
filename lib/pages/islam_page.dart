            ...
            Padding(
              ...
              child: Column(
                children: [
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.all(16),
                            child: const Text(
                              '“Ва аз нишонаҳои Худо он аст, ки барои шумо аз ҷинси худатон занон офарид, то бо онҳо ором гиред ва дар миёни шумо дӯстию меҳрубонӣ пайдо кард. Ба дурустӣ, дар ин кор барои гурӯҳе, ки андеша мекунанд, нишонаҳое ҳаст.”\n(Сураи Рум, ояти 21)',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w800),
                  ...
                  const Text(
                    'Меҳри зан барои мард ин оромии дил мебошад, чунончӣ дар Қуръони карим омадааст: ',
                    style: TextStyle(
                        color: Color(0xFF654900),
                        fontSize: 18,
                        fontWeight: FontWeight.w800),
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.all(16),
                            child: const Text(
                              '“Ў Он [Худой] аст, ки шуморо аз як нафс офарид ва занашро аз ў пайдо кард, то бо вай ором гирад...”\n(Сураи Аъроф, ояти 189)',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w800),
                  ...
                  const Text(
                    'Дар ҷои дигар Аллоҳи бузург мефармояд:',
                    style: TextStyle(
                        color: Color(0xFF654900),
                        fontSize: 18,
                        fontWeight: FontWeight.w800),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        const Text(
                          'Ҳамеша дар ёд бояд дошт, ки дар муносибатҳои оилавӣ муҳиманд:',
                          style: TextStyle(
                              color: Color(0xff654900),
                              fontSize: 16,
                              fontWeight: FontWeight.w800),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: const Text(
                                    'Дастгирӣ намудани ҳисси номуси\nшахсии шавҳар ва зан;',
                                    style: TextStyle(
                                        color: Color(0xff654900),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w800),
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width:
                                      MediaQuery.of(context).size.width * 0.78,
                                  child: const Text(
                                    'Доимо нишон додани иззату ҳурмати\nҳамдигар;',
                                    style: TextStyle(
                                        color: Color(0xff654900),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w800),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: const Text(
                                    'Дар худ нигоҳ доштан ва хомӯш\nнамудани қаҳру ғазаб, ҷаҳл ва\nасабоният;',
                                    style: TextStyle(
                                        color: Color(0xff654900),
                                        fontSize: 16,
                                        fontWeight: FontWeight.w800),
