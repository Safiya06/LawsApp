...
class Dastur62RuPage extends StatelessWidget {
  const Dastur62RuPage({super.key});
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  const Text('Тоҷикӣ', style: TextStyle(color: Color(0xFF654900),fontSize:37,fontWeight: FontWeight.w800)),
                  const Text(textAlign: TextAlign.center,'Ҷазо барои содир намудани зӯроварӣ', style: TextStyle(color: Color(0xFF654900),fontSize:27,fontWeight: FontWeight.w800)),
                  Container(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  const Text('Русский', style: TextStyle(color: Color(0xFF654900),fontSize:37,fontWeight: FontWeight.w800)),
                  const Text(textAlign: TextAlign.center,'Наказание за совершение насилия', style: TextStyle(color: Color(0xFF654900),fontSize:27,fontWeight: FontWeight.w800)),
                  Container(
                    padding: const EdgeInsets.all(16),
                    height: 23,
                    decoration: BoxDecoration(
